...
| FR-26 | Normal Vision launch requests one independent medical-education window; closing or entering an immersive space does not grant the assistant control over anatomy or tracking. | Scene/source invariant, simulator launch, and physical window review. |
