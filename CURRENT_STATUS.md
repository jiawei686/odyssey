...
within 14 degrees of its forward pose. Voice is the default visible input mode,
but capture starts only after an explicit microphone press. On-device partial
transcription, one-utterance silence-based submission, streamed answer
